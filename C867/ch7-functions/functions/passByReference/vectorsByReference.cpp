...
// Constant is used for the sake of efficiency. Compilers will generate more efficient code if there is a local copy in this case.
// Constants are a good idea for a function that will not modify the parameter
// Passing by reference is a good idea for large data structures
